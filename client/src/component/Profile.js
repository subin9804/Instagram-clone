                    ...
                    <div className="grow ml-4">
                        <div className="flex items-center mb-4">
                            ...
                            {isMaster && (
                                <>
                                    {/* 정보수정 버튼 */}
                                    <Link to="/accounts/edit" className="shrink-0 ml-2 bg-gray-200 rounded-lg px-4 py-2 text-sm font-semibold">
                                        Edit profile
                                    </Link>
                                    {/* 로그아웃 버튼 */}
                                    <button
                                        className="ml-1 bg-gray-200 px-4 py-2 text-sm font-semibold rounded-lg"
                            ...
                            {(!isMaster && !profile.isFollowing) && (
                                <button
                                    className="ml-2 bg-blue-500 text-sm text-white px-4 py-2 font-semibold p-2 rounded-lg"
